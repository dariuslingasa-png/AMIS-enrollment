<div x-transition class="parent-info-flow">
    <div style="background:#eff6ff;border:1px solid #bfdbfe;color:#1e40af;padding:0.75rem 1rem;border-radius:12px;font-size:0.83rem;font-weight:600;display:flex;align-items:center;gap:0.5rem;margin-bottom:1.25rem;">
        ...
        <span>Please fill in at least <strong>Father's Name</strong> or <strong>Mother's Name</strong> (First & Last Name).</span>
    </div>
                ...
                <div class="contact-number-grid">
                    <div class="country-combobox phone-code-combobox" x-data="{ open: false, search: '' }" @click.outside="open = false">
                        <button type="button" class="country-combobox-trigger phone-code-trigger" :class="{ 'is-invalid-field': isFieldInvalid('parent_country_code') }" @click="open = !open">
                            ...
                            <span class="country-combobox-value" x-text="form.parent_country_code || '+63'"></span>
                            <svg class="country-combobox-chevron" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2"><path d="m6 9 6 6 6-6"/></svg>
                        </button>
