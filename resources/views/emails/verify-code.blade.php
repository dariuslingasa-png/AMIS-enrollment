...
<body style="margin:0;padding:0;background:#f4f7f5;font-family:Arial,Helvetica,sans-serif;color:#111827;">
    <div style="display:none;max-height:0;overflow:hidden;opacity:0;color:transparent;">
        Your AMIS online enrollment verification code is {{ $code }}.
    </div>
                    ...
                    <tr>
                        <td style="padding:34px 32px 28px;">
                            ...
                            <p style="margin:0 0 18px;font-size:15px;line-height:1.7;color:#4b5563;">
                                Assalamu alaikum. Please use the 4-digit verification code below to verify your email address and continue to your pre-enrollment application dashboard.
                            </p>
                            ...
                            <p style="margin:0;font-size:13px;line-height:1.7;color:#6b7280;">
                                If you did not request a verification code for AMIS enrollment, you can safely ignore this email.
                            </p>
                        </td>
                    </tr>
